...
###  Lets go underneath the regions and the income groupings to better see the underlying


###  migration patterns of the 2 genders better
...
### Trying to understand the contradictory migration patterns  between more developed regions

### vs. high income countries and less developed regions vs. low income countries?
...
(2) Then make a migratory trend comparision along gender lines to see if there are any 

discerning (clear) migratory behavior between genders.
...
### One last question was in the poorer Nations, which country experienced the most number of 
...
developed regions" as well.  However, what is paradoxical, was the trends that showed women

were outpacing men in the "developed regions" and was also better in the low income

countries.  This was an ironic "findings" that deserved further investigations and analysis to
...
men 51% vs. 49%.  This statistics curiously was exactly the opposite in poorer countries with

men having the advantage.  

- It was also shown that within the poor countries, Venezuela, Syria and Mexico had the most

migration flow activities, most probably stemming from internal socio-economic issues
