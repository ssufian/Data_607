...
- To test out the new database, Let’s say we wanted to know Which airlines has the best arrival time in

the past year of 2013?  
...
ggplot(data=results, aes(x=carrier_name, y=arr_delay)) + geom_bar(stat="identity" )+
    ...
    guides(fill=FALSE) +
    xlab("Airlines") + ylab("Early Arrival") + coord_flip()+
